...
const STORAGE_KEYS = {
  ...
  EMAIL_SMS_TEMPLATES: 'bugworx_email-sms-templates',
  NOTIFICATION_RULES: 'bugworx_notification-rules',
  REPORT_DISTRIBUTIONS: 'bugworx_report-distributions',
  SYSTEM_MESSAGES: 'bugworx_system-messages',
