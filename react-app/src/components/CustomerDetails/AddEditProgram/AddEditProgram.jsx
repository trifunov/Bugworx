const AddEditProgram = ({ isOpen, formData, errors, isSaving, onUpdateField, onClose, onSave }) => {
  ...
  return (
    <>
      <div className={`offcanvas offcanvas-end show`} tabIndex='-1' style={{ width: '720px', maxWidth: '95vw' }}>
        <div className='offcanvas-header'>
          <h5 className='offcanvas-title'>{formData.id && formData.id !== 0 ? 'Edit Program' : 'Add Program'}</h5>
        ...
        <div className='offcanvas-body offcanvas-scrollable'>
          <form onSubmit={handleSubmit}>
            ...
            <div className='mb-3'>
              <label htmlFor='serviceAddressId' className='form-label'>
                Service Address ID
              </label>
              <input
                type='number'
            ...
            <div className='row'>
              <div className='col-md-6 mb-3'>
                <label htmlFor='programTypeId' className='form-label'>
                  Program Type
                </label>
                <select
            ...
            <div className='row'>
              <div className='col-md-6 mb-3'>
                <label htmlFor='contractDuration' className='form-label'>
                  Contract Duration
                </label>
                <select
                  className='form-select'
              ...
              <div className='col-md-6 mb-3'>
                <label htmlFor='programCategory' className='form-label'>
                  Program Category
                </label>
                <select
                  className='form-select'
            ...
            <div className='mb-3'>
              <label htmlFor='accountManager' className='form-label'>
                Account Manager
              </label>
              <input
                type='text'
            ...
            <div className='mb-3'>
              <label htmlFor='regulatoryRequirements' className='form-label'>
