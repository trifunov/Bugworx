            ...
            >
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleCompanyChange("regNumber", e.target.value)
                  }
                  type="text"
                  className="form-control"
        ...
        <div className="card">
          <div className="card-body text-center">
            ...
            <div className="mb-3">
              <img
                src={
                  companyProfile.logo || "/assets/images/placeholder-logo.png"
                }
                alt="logo"
            ...
            <button
              type="button"
              onClick={() => {
                pushAudit("admin", "Upload", "CompanyLogo", "manual");
                alert("Logo saved (if changed)");
              }}
