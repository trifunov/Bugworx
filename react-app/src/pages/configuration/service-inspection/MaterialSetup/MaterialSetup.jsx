...
const MaterialSetup = () => {
  ...
  const renderRow = (item) => (
    <tr key={item.id}>
      ...
      <td>
        {item.sdsUrl ? (
          <a href={item.sdsUrl} target="_blank" rel="noopener noreferrer" className="btn btn-sm btn-link">View SDS</a>
        ) : 'N/A'}
      </td>
      <td>
        <div className="d-flex gap-3">
          <a className="text-primary" href="#" title="Edit" onClick={(e) => { e.preventDefault(); addEditMaterialSetup.open(item); }}><i className="mdi mdi-pencil font-size-18"></i></a>
