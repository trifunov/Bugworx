...
const TreatmentTypes = () => {
  ...
  const { data: paginatedData, ...tableProps } = useTable(filteredItems, { defaultSortField: 'method' });
    ...
    <tr key={item.id}>
      ...
      <td>
        <div className="d-flex gap-3">
          <a className="text-primary" href="#" title="Edit" onClick={(e) => { e.preventDefault(); addEditTreatmentType.open(item); }}><i className="mdi mdi-pencil font-size-18"></i></a>
