...
// Service Programs - recurring treatment plans that generate Work Orders
export const programs = [
  {
    id: 1,
    leadId: 1,
    name: 'Monthly General Pest Control',
    serviceType: 'General Pest Control',
    frequency: 'monthly',
    status: 'Active',
    startDate: formatDate(new Date(today.getFullYear(), 0, 1)), // Jan 1 this year
    endDate: formatDate(new Date(today.getFullYear(), 11, 31)), // Dec 31 this year
    serviceAddressIds: [1],
    assignedTechnicianId: 1,
    estimatedDuration: 45,
    notes: 'Regular monthly residential service. Ring doorbell, dog in backyard.',
    totalWorkOrders: 12,
    completedWorkOrders: today.getMonth(),
  ...
  },
  {
    id: 2,
    leadId: 2,
    name: 'Quarterly Termite Inspection',
    serviceType: 'Termite Inspection',
    frequency: 'quarterly',
    status: 'Active',
    startDate: formatDate(new Date(today.getFullYear(), 0, 1)),
    endDate: null, // ongoing
    serviceAddressIds: [2, 3],
    assignedTechnicianId: 2,
    estimatedDuration: 90,
    notes: 'Commercial quarterly termite inspection. Check in with security.',
    totalWorkOrders: 4,
    completedWorkOrders: Math.floor(today.getMonth() / 3),
    createdAt: new Date(today.getFullYear(), 0, 1).toISOString(),
    updatedAt: new Date().toISOString()
  },
  {
    id: 3,
    leadId: 3,
    name: 'Monthly Restaurant Pest Control',
    serviceType: 'General Pest Control',
    frequency: 'monthly',
    status: 'Active',
    startDate: formatDate(new Date(today.getFullYear(), 0, 1)),
    ...
    assignedTechnicianId: 1,
    estimatedDuration: 45,
    notes: 'Health compliance program. Service before 10 AM only.',
    totalWorkOrders: 12,
    completedWorkOrders: today.getMonth(),
    createdAt: new Date(today.getFullYear(), 0, 1).toISOString(),
    updatedAt: new Date().toISOString()
  },
  {
    ...
    assignedTechnicianId: 3,
    estimatedDuration: 75,
    notes: 'Bait station monitoring. Paused pending site access renewal.',
    totalWorkOrders: 12,
    completedWorkOrders: 8,
    createdAt: new Date(today.getFullYear() - 1, 0, 1).toISOString(),
    updatedAt: new Date().toISOString()
  }
];
